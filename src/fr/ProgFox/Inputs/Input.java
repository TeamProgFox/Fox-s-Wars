...
public class Input {
	...
	public static final int KEY_SPACE = 0x20, KEY_APOSTROPHE = 0x27, KEY_COMMA = 0x2C, KEY_MINUS = 0x2D,
			KEY_PERIOD = 0x2E, KEY_SLASH = 0x2F, KEY_0 = 0x30, KEY_1 = 0x31, KEY_2 = 0x32, KEY_3 = 0x33, KEY_4 = 0x34,
			KEY_5 = 0x35, KEY_6 = 0x36, KEY_7 = 0x37, KEY_8 = 0x38, KEY_9 = 0x39, KEY_SEMICOLON = 0x3B,
			KEY_EQUAL = 0x3D, KEY_A = 0x41, KEY_B = 0x42, KEY_C = 0x43, KEY_D = 0x44, KEY_E = 0x45, KEY_F = 0x46,
			KEY_G = 0x47, KEY_H = 0x48, KEY_I = 0x49, KEY_J = 0x4A, KEY_K = 0x4B, KEY_L = 0x4C, KEY_M = 0x4D,
			KEY_N = 0x4E, KEY_O = 0x4F, KEY_P = 0x50, KEY_Q = 0x51, KEY_R = 0x52, KEY_S = 0x53, KEY_T = 0x54,
			KEY_U = 0x55, KEY_V = 0x56, KEY_W = 0x57, KEY_X = 0x58, KEY_Y = 0x59, KEY_Z = 0x5A, KEY_LEFT_BRACKET = 0x5B,
			KEY_BACKSLASH = 0x5C, KEY_RIGHT_BRACKET = 0x5D, KEY_GRAVE_ACCENT = 0x60, KEY_WORLD_1 = 0xA1,
			KEY_WORLD_2 = 0xA2;

	public static final int KEY_ESCAPE = 0x100, KEY_ENTER = 0x101, KEY_TAB = 0x102, KEY_BACKSPACE = 0x103,
	...
	public static final int JOYSTICK_1 = 0x0, JOYSTICK_2 = 0x1, JOYSTICK_3 = 0x2, JOYSTICK_4 = 0x3, JOYSTICK_5 = 0x4,
			JOYSTICK_6 = 0x5, JOYSTICK_7 = 0x6, JOYSTICK_8 = 0x7, JOYSTICK_9 = 0x8, JOYSTICK_10 = 0x9,
			JOYSTICK_11 = 0xA, JOYSTICK_12 = 0xB, JOYSTICK_13 = 0xC, JOYSTICK_14 = 0xD, JOYSTICK_15 = 0xE,
			JOYSTICK_16 = 0xF, JOYSTICK_LAST = JOYSTICK_16;
